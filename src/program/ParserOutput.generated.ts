...
export interface Fnd extends RuleOutput {type: 'fnd', value: [Var[], Typ, Exp] | [Var[], Exp] | [Var[], Tc];}
...
export interface Ftp extends RuleOutput {type: 'ftp', value: [Typ] | [Typ[], Typ];}
...
const FilteredParserNames_ = ['doc', 'mnl', 'wnl', 'bls', 'sta', 'sep', 'rec', 'eob', 'blo', 'ifl', 'ifn', 'exp', 'eod', 'exa2', 'emo2', 'emo1', 'emo0', 'exa1', 'exa0', 'dott', 'vcf', 'mws', 'ws', 'sc2', 'sc1', 'sc0', 'op2', 'op1', 'op0', 'cm2', 'cm1', 'cm0', 'cl2', 'cl1', 'cl0', 'typ', 'tps', 'tcl', 'vrl'] as const;
...
export const instructions: {[key in DirtyParserName]: Instruction} = {doc: 'fu', mnl: 'd', wnl: 'd', ass: 'fl', ret: 'fl', brk: 'fl', cnt: 'fl', bls: 'fu', sta: 'fu', sep: 'd', rec: 'fu', eob: 'fu', blo: 'ff', ife: 'fl', ifl: 'fu', ifn: 'ff', ifb: 'fl', dow: 'fl', wdo: 'fl', for: 'fl', doo: 'fl', exp: 'fu', eod: 'fu', fnd: 'fl', exa2: 'fu', exc2: 'fm', exc1: 'fm', exc0: 'fm', exl2: 'fm', exl1: 'fm', exl0: 'fm', emo2: 'fu', emo1: 'fu', emo0: 'fu', ars2: 'fl', ars1: 'fl', ars0: 'fl', arre: 'fl', exm2: 'fl', exm1: 'fl', exm0: 'fl', exo2: 'fm', exo1: 'fm', exo0: 'fm', exa1: 'fu', exa0: 'fu', dott: 'fu', dot: 'fl', vcf: 'fu', mws: 'd', ws: 'd', sc2: 'fu', sc1: 'fu', sc0: 'fu', op2: 'fu', op1: 'fu', op0: 'fu', cm2: 'd', cm1: 'd', cm0: 'd', cl2: 'fu', cl1: 'fu', cl0: 'fu', typ: 'fu', mtp: 'fl', ttp: 'fl', atp: 'fl', ftp: 'fl', tps: 'ff', tcl: 'd', var: 'fl', vrl: 'ff'};
