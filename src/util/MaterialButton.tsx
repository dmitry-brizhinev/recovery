...
export default function MaterialButton(props: {icon: MaterialIcon, onClick?: Func, className?: string | undefined, size?: MaterialSize, dark?: boolean, disabled?: boolean;}) {
